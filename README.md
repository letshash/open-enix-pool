...
**This pool is being further developed to provide an easy to use pool for Enix miners. This software is functional however an optimised release of the pool is expected soon. Testing and bug submissions are welcome!**
